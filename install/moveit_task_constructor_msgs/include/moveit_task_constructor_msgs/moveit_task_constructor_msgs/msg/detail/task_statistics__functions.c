...
moveit_task_constructor_msgs__msg__TaskStatistics__create(void)
{
...
moveit_task_constructor_msgs__msg__TaskStatistics__Sequence__init(moveit_task_constructor_msgs__msg__TaskStatistics__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(moveit_task_constructor_msgs__msg__TaskStatistics)) {
      return false;
    }
  ...
  moveit_task_constructor_msgs__msg__TaskStatistics__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(moveit_task_constructor_msgs__msg__TaskStatistics)) {
      return false;
    }
